                    ...
                    if (results == null || results.length == 0) {
                        ...
                        bcrypt.compare(user.userPwd, results[0].password, function (err, resPwd) {
                            if (resPwd) {
                                ...
                                jwt.sign({ userTel: user.userTel, userId: results[0].userId, role: results[0].role,userStatus:results[0].userStatus }, 'privateKey', { expiresIn: 60 *180 }, function (err, token) {
