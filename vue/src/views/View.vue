      ...
      <div class="box">
        <div class="box-1">
          <ul style="padding: 0;margin-left: 170px;">
            <li @click="child(3,4)">
              <img src="../assets/view/bg5.jpg" />
            </li>
            <li @click="postGameId(469)">
              <img src="../assets/view/bg4.jpg" />
            </li>
            <li @click="postGameId(467)">
              <img src="../assets/view/bg5.jpg" />
            </li>
            <li @click="postLabelId(468,5)">
              <img src="../assets/view/bg4.jpg" />
            </li>
            <li @click="postLabelId(7,5)">
              <img src="../assets/view/bg5.jpg" />
            </li>
          </ul>
        </div>
      ...
      <div class="sTrip">
        ...
        <div class="main_news trips_con">
          <ul>
            ...
            <li>
              <a href="#" target="_blank">
                <img src="../assets/view/leftPic4.jpg" />
                <div class="txt">
                  <h3>
                    <em>04</em> 标题
                  </h3>
      ...
      <div>
        ...
        <div class="contain strategy">
          <ul style="display: flex;flex-direction: row;justify-content:space-between">
            ...
            <li>
              <a href target="_blank">
                <img src="../assets/view/leftPic6.jpg" />
                <div class="strategy_msk"></div>
                <div class="strategy_txt tit">
                  <div class="strategy_tit">title</div>
                </div>
