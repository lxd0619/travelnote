          ...
          <ul class="termini_list">
            ...
            <li class="br1 pt15">
              ...
              <dl class="termini_name">
                <dt>中南地区</dt>
                <dd data-events="click">
                  <a href="#" target="_blank">河南省</a>
                </dd>
                <dd data-events="click">
                  <a href="#" target="_blank">湖北省</a>
                </dd>
                <dd data-events="click">
                  <a href="#" target="_blank ">湖南省</a>
                </dd>
                <dd data-events="click ">
                  <a href="# " target="_blank ">广东省</a>
                </dd>
                <dd data-events="click ">
                  <a href="# " target="_blank ">广西壮族自治区</a>
                </dd>
                <dd data-events="click ">
                  <a href="# " target="_blank ">海南省</a>
                </dd>
                <dd data-events="click ">
                  <a href="# " target="_blank ">香港特别行政区</a>
                </dd>
                <dd data-events="click ">
                  <a href="# " target="_blank ">澳门特别行政区</a>
                </dd>
              </dl>
            </li>
            <li class="br1 pt15">
              ...
              <dl class="termini_name">
                <dt>西南地区</dt>
                <dd data-events="click ">
                  <a href="# " target="_blank ">重庆市</a>
                </dd>
                <dd data-events="click ">
                  <a href="# " target="_blank ">四川省</a>
                </dd>
                <dd data-events="click ">
                  <a href="# " target="_blank ">贵州省</a>
                </dd>
                <dd data-events="click ">
                  <a href="# " target="_blank ">云南省</a>
                </dd>
                <dd data-events="click ">
                  <a href="# " target="_blank ">西藏自治区</a>
                </dd>
              </dl>
            </li>
            <li class="pt15">
              ...
              <dl class="termini_name">
                <dt>西北地区</dt>
                <dd data-events="click ">
                  <a href="# " target="_blank ">陕西省</a>
                </dd>
                <dd data-events="click ">
                  <a href="# " target="_blank ">甘肃省</a>
                </dd>
                <dd data-events="click ">
                  <a href="# " target="_blank ">青海省</a>
                </dd>
                <dd data-events="click ">
                  <a href="# " target="_blank ">新疆维吾尔自治区</a>
                </dd>
                <dd data-events="click ">
                  <a href="# " target="_blank ">宁夏回族自治区</a>
                </dd>
              </dl>
            </li>
          </ul>
